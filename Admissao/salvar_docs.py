...
abert_c.paragraphs[14].text = str(abert_c.paragraphs[14].text).replace('#nome_completo', pessoa.nome).replace(
    ...
    '#cpf', pessoa.cpf).replace('#endereco', pessoa.endereco).replace('#cep', pessoa.cep) \
    .replace('#bairro', pessoa.bairro).replace('#cargo', pessoa.cargo).replace('#data', pessoa.nascimento)
...
fch_c.paragraphs[15].text = str(fch_c.paragraphs[15].text).replace('#ident', pessoa.rg).replace('#cpf#', pessoa.cpf)
...
fch_c.paragraphs[10].text = str(fch_c.paragraphs[10].text).replace('#nasc', pessoa.nascimento) \
    .replace('#gen', pessoa.genero).replace('#est_civ', pessoa.estado_civil)
