...
def gerar_planilha_pgto_itau(nome1, nome2, nome3, nome4, nome5, nome6, nome7, nome8, nome9, nome10, nome11, nome12,
    ...
    sh = wb['Planilha1']
    pessoa1 = session.query(Colaborador).filter_by(nome=nome1).order_by(Colaborador.matricula.desc()).first()
    pessoa2 = session.query(Colaborador).filter_by(nome=nome2).order_by(Colaborador.matricula.desc()).first()
    pessoa3 = session.query(Colaborador).filter_by(nome=nome3).order_by(Colaborador.matricula.desc()).first()
    pessoa4 = session.query(Colaborador).filter_by(nome=nome4).order_by(Colaborador.matricula.desc()).first()
    pessoa5 = session.query(Colaborador).filter_by(nome=nome5).order_by(Colaborador.matricula.desc()).first()
    pessoa6 = session.query(Colaborador).filter_by(nome=nome6).order_by(Colaborador.matricula.desc()).first()
    pessoa7 = session.query(Colaborador).filter_by(nome=nome7).order_by(Colaborador.matricula.desc()).first()
    pessoa8 = session.query(Colaborador).filter_by(nome=nome8).order_by(Colaborador.matricula.desc()).first()
    pessoa9 = session.query(Colaborador).filter_by(nome=nome9).order_by(Colaborador.matricula.desc()).first()
    pessoa10 = session.query(Colaborador).filter_by(nome=nome10).order_by(Colaborador.matricula.desc()).first()
    pessoa11 = session.query(Colaborador).filter_by(nome=nome11).order_by(Colaborador.matricula.desc()).first()
    pessoa12 = session.query(Colaborador).filter_by(nome=nome12).order_by(Colaborador.matricula.desc()).first()
    pessoa13 = session.query(Colaborador).filter_by(nome=nome13).order_by(Colaborador.matricula.desc()).first()
    pessoa14 = session.query(Colaborador).filter_by(nome=nome14).order_by(Colaborador.matricula.desc()).first()
    pessoa15 = session.query(Colaborador).filter_by(nome=nome15).order_by(Colaborador.matricula.desc()).first()
