...
linha = 106
click = 265
while sh[f"K{linha}"].value != None:
    pa.click(1402, click), t.sleep(0.2)
    nome = str(sh[f"K{linha}"].value)
    pasta = f'\\\Qnapcia\\rh\\01 - RH\\01 - Administração.Controles\\02 - Funcionários, Departamentos e Férias\\000 - Pastas Funcionais\\00 - ATIVOS\\{nome}\\Diversos\\AV Desemp {nome}.jpg'
    def main():
